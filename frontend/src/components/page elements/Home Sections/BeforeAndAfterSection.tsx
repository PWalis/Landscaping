    ...
    return (
        <section className="h-auto bg-stone-300/40 flex items-center justify-center" id="BeforeAndAfter">
            <div className="mt-20 mb-5">
                ...
                <p className="text-lg text-center text-stone-900  m-10 p-5 bg-stone-300"> Take a look at how we can transform your outdoor space into a place where you truly feel at home! </p>
                <div className="flex flex-col gap-2 text-center justify-center items-center">
                    <div className="max-w-[1000px] p-1">
                    <BeforeAndAfterImg afterImage={afterImage1} beforeImage={beforeImage1}/>
                    <p className="text-justify text-stone-800/80  bg-stone-300/60 m-10 p-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt quae, omnis consequuntur molestias nisi assumenda excepturi provident sunt enim at dicta deleniti repellat, quos neque tempora aliquam, nam ipsam officiis.</p>
