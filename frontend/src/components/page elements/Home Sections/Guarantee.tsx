...
const Guarantee: FC = () => {
    return (
        <section className="h-auto bg-stone-300/90 flex items-center justify-center" id="Guarantee">
          <div className="mt-20 mb-20 flex flex-row flex-wrap justify-center items-center gap-10">
