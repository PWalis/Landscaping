    ...
    return (
        <section className="h-lvh bg-stone-300/50 flex flex-col items-center">
            ...
            <div className="flex-col">
                ...
                <p className="text-xl text-zinc-500 max-w-xl pt-3">"A well-maintained yard not only looks great, but it also creates a welcoming environment for you and your family. Our yard clean-up services are designed to help you achieve just that. From leaf removal to debris cleanup, we'll leave your yard looking neat and tidy." </p>
                </div>
                <img
                ...
                <div className="text-center pt-14 pb-10"> <h1 className="text-3xl text-stone-600 italic"> The Services Our Customers Love:  </h1></div>

            <div className="flex justify-center gap-10">
                <div className="flex flex-col items-center"> <img className="w-20 h-auto" src={GardeningShearsImage} alt="Gardening Shears for Landscaping"/>
                ...
                <div className="flex flex-col items-center"> <img className="w-20 h-auto" src={MaintenanceImage} alt="Maintenance for Landscaping"/>
                <div className="bg-green-300/40 p-4 mb-4">
                    <h2 className="text-4xl font-bold text-zinc-600 pb-3">Maintenance</h2>
                    <p className="text-zinc-500">Is your yard in need of a little TLC? Our yard clean-up services can help get things back in shape. We'll remove debris, trim overgrown shrubs, and make sure your yard looks its best.</p>
                </div>
                    </div>
            </div>
            </div>
